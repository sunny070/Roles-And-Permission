            ...
            <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                <form method="POST" action="{{ route('admin.permissions.update',$permission) }}">
                  ...
                  <div class="sm:col-span-6">
                    <label for="title" class="block text-sm font-medium text-gray-700"> Update Permission </label>
                    <div class="mt-1">
                      <input type="name" 
                      id="name"  
                      name="name" 
                  ...
                  <div class="sm:col-span-6 pt-5">
                   <button type="submit" class="px-4 py-2 bg-gray-500 hover:bg-gray-400 rounded-md ">Update</button> 
                    </div>
                  </div>
                </form>
            </div>
